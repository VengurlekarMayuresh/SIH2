  ...
  const studentsData = [
    {
      ...
      class: "Grade 8A",
      avatar: "https://ui-avatars.com/api/?name=Alice+Johnson&size=32&background=random",
      quizzesCompleted: 8,
      totalQuizzes: 12,
      averageScore: 87,
    ...
    },
    {
      ...
      email: "bob@email.com",
      class: "Grade 8A",
      avatar: "https://ui-avatars.com/api/?name=Bob+Smith&size=32&background=random",
      quizzesCompleted: 6,
      totalQuizzes: 12,
      averageScore: 92,
    ...
    },
    {
      ...
      class: "Grade 8B",
      avatar: "https://ui-avatars.com/api/?name=Carol+Davis&size=32&background=random",
      quizzesCompleted: 12,
      totalQuizzes: 12,
      averageScore: 95,
    ...
    },
    {
      ...
      class: "Grade 9A",
      avatar: "https://ui-avatars.com/api/?name=David+Wilson&size=32&background=random",
      quizzesCompleted: 4,
      totalQuizzes: 12,
      averageScore: 78,
